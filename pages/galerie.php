...
$typ = new Galeriedb($cnx);
$types = $typ->getAllImages();
$nbr_type = count($types);

//récupération des produits
$vue = new Vue_destinations_genre_typeDB($cnx);
        ...
        for ($i = 0; $i < $nbr; $i++) {
            ...
            <div class="row">
                ...
                <div class="col-sm-5 text-center borderBottom">
					...
					<p>
					  <br/>
					  <a href="index.php?page=client.php&id_pdesti=<?php print $liste[$i]['id_desti'];?> " > 
						Acheter
					  </a>
					</p>
